  ...
  return <section className="border-b border-black">
    <div className="shell py-6 md:py-8">
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="text-right"><div className="mono text-[9px] font-bold text-[#777269]">01 主卡 · 02 副卡</div>{sameProduct ? <div className="mt-1 text-[9px] text-[#777269]">同一产品 · 两条独立事件</div> : null}</div>
      </div>
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-[1.35fr_.85fr]">
        <article className="grid border border-black bg-white lg:grid-cols-[150px_1fr]">
          ...
          <div className="flex min-w-0 flex-col p-5 md:p-6">
            ...
            {primary.eventLabel ? <div className="mt-1 text-[10px] font-bold text-[#777269]">{primary.eventLabel}</div> : null}
        ...
        {secondary ? <article className="flex min-w-0 flex-col border border-black bg-[#ebe9e2] p-5 md:p-6">
          ...
          {secondary.eventLabel ? <div className="mt-1 text-[10px] font-bold text-[#777269]">{secondary.eventLabel}</div> : null}
